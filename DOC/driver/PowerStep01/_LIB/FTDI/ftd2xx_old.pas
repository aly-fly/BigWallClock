...
uses
  Windows, WinTypes, Messages, SysUtils, Dialogs, Classes;
...
{$EXTERNALSYM FT_VendorCmdSetEx}
  ...
  function  FT_ReadFromDevice(DeviceIndex, NumberOfBytes: Integer; Mesage: Boolean): Cardinal;
...
begin
  ...
  begin
    if FT_DeviceInfoList[I].Description = DeviceName then
    begin
      Result := I;
      Exit;
    end;
